...
```{r print_mean_coverages_barplot}
mean_coverages_barplot
```

```{r print_coverage_per_sample_boxplot}
coverage_per_sample_boxplot
```

## Per Target Region

```{r print_coverage_per_region_hist}
coverage_per_region_hist
```

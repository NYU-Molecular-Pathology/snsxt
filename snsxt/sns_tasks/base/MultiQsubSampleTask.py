...
class MultiQsubSampleTask(AnalysisSampleTask):
    """
    Base class for an ``AnalysisSampleTask`` operates on each sample in the analysis, and multiple qsub jobs for each.
